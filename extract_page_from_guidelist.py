...
class DetectGuideList:
    ...
    @staticmethod
    def readPagefromList(list_page_url,pagenums=5,use_date=False,from_date=None,till_date=None):
        '''
        ...
        if use_date is True:
            ...
            for i in range(1, pagenums+1):
                ...
                response1 = Connector.connectToUrl(htm_url,params={"page": i,'from':standard_from_time,'till':standard_till_time})
